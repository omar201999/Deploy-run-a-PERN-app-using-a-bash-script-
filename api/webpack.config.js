...
if (environment === 'demo') {
  ENVIRONMENT_VARIABLES = {
    'process.env.HOST': JSON.stringify('10.0.2.15'),
    'process.env.USER': JSON.stringify('omar'),
    'process.env.DB': JSON.stringify('demo_app_db'),
    'process.env.DIALECT': JSON.stringify('postgres'),
    'process.env.PORT': JSON.stringify('3080'),
    'process.env.PG_CONNECTION_STR': JSON.stringify("postgres://omar:'omar'@localhost:5432/demo_app_db")
  };
